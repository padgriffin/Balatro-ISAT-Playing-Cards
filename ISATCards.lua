...
SMODS.Atlas {
  key = "collab_isat_hearts_3",
  path = "collab_ISAT_hearts_3.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_spades_3",
  path = "collab_ISAT_spades_3.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_diamonds_3",
  path = "collab_ISAT_diamonds_3.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_clubs_3",
  path = "collab_ISAT_clubs_3.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_hearts_4",
  path = "collab_ISAT_hearts_4.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_spades_4",
  path = "collab_ISAT_spades_4.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_diamonds_4",
  path = "collab_ISAT_diamonds_4.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
SMODS.Atlas {
  key = "collab_isat_clubs_4",
  path = "collab_ISAT_clubs_4.png",
  px = 71,
  py = 95,
  atlas_table = 'ASSET_ATLAS'
}
...
SMODS.DeckSkin{
  key = "collab_isat_spades_alt",
  suit = "Spades",
  ranks =  {"Jack", "Queen", "King"},
  display_ranks = {"Jack", "Queen", "King"},    
  lc_atlas = "collab_isat_spades_3",
  hc_atlas = "collab_isat_spades_4",
  loc_txt = {
    ["en-us"] = "In Stars and Time (Alt)"
  },
  posStyle = "collab"
  }

SMODS.DeckSkin{
  key = "collab_isat_hearts_alt",
  suit = "Hearts",
  ranks =  {"Jack", "Queen", "King"},
  display_ranks = {"Jack", "Queen", "King"},
  lc_atlas = "collab_isat_hearts_3",
  hc_atlas = "collab_isat_hearts_4",
  loc_txt = {
    ["en-us"] = "In Stars and Time (Alt)"
  },
  posStyle = "collab"
...
SMODS.DeckSkin{
  key = "collab_isat_clubs_alt",
  suit = "Clubs",
  ranks =  {"Jack", "Queen", "King"},
  display_ranks = {"Jack", "Queen", "King"},
  lc_atlas = "collab_isat_clubs_3",
  hc_atlas = "collab_isat_clubs_4",
  loc_txt = {
    ["en-us"] = "In Stars and Time (Alt)"
  },
  posStyle = "collab"
...
SMODS.DeckSkin{
  key = "collab_isat_diamonds_alt",
  suit = "Diamonds",
  ranks =  {"Jack", "Queen", "King"},
  display_ranks = {"Jack", "Queen", "King"},
  lc_atlas = "collab_isat_diamonds_3",
  hc_atlas = "collab_isat_diamonds_4",
  loc_txt = {
    ["en-us"] = "In Stars and Time (Alt)"
  },
  posStyle = "collab"
